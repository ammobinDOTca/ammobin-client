...
export function getConfig(
  ...
  // always serve these french ones
  if (locale === 'fr' || page === 'fr-home') {
    if (page === 'LANG' || page === 'fr-home') {
      return mobile
        ? {
          img: 'https://store-udt1amkaxd.mybigcommerce.com/content/ammobin/home-mobile-fr.png',
